...
rhoh.grid<-as.matrix(read.csv("grid3.csv",header=FALSE,sep=","))
...
#e_h=76.58332678
#e_w=10.60954323
logmle<-log(c(0.126546009,0.001585289,0.249549543,0.002278763,0.036362131,0.040142494,0.022053161,76.58332678,10.60954323))
...
for(i in 1:long1){
	 ...
	 print(mle.loop)
	  ...
	  write.table(results,file="resultsrhow3.csv",sep=",",col.names=FALSE,row.names=FALSE)
 }
