...
rhoqw.grid<-as.matrix(read.csv("grid22.csv",header=FALSE,sep=","))
...
for(i in 1:long1){
	 ...
	 log.x0<-mle.loop$solution write.table(results,file="resultsrhoqw22.csv",sep=",",col.names=FALSE,row.names=FALSE)
 }
