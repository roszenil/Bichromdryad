...
rhoqw.grid<-as.matrix(read.csv("grid8.csv",header=FALSE,sep=","))
...
for(i in 1:long1){
	 ...
	 log.x0<-mle.loop$solution write.table(results,file="resultsrhoqw8.csv",sep=",",col.names=FALSE,row.names=FALSE)
 }
