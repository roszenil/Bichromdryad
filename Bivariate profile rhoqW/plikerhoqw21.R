...
rhoqw.grid<-as.matrix(read.csv("grid21.csv",header=FALSE,sep=","))
...
for(i in 1:long1){
	 ...
	 log.x0<-mle.loop$solution write.table(results,file="resultsrhoqw21.csv",sep=",",col.names=FALSE,row.names=FALSE)
 }
